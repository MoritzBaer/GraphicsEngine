...
public:
  void Create(VkFormat format, VkExtent3D extent, VkImageUsageFlags usage, VkImageAspectFlags aspectMask,
...
void Engine::Graphics::Image<Dimension>::Create(VkFormat format, VkExtent3D extent, VkImageUsageFlags usage,
