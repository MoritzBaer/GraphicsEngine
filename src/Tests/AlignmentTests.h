...
TEST_ASSERT_EQUAL_SIZE(Vec3Alignment, "actual", Vec3AlignmentExplicit, "wanted", "Vector3 not aligned correctly!")
...
TEST_ASSERT(sizeof(ExplicitVertex) == sizeof(Vertex), "Vertex not aligned correctly!")

Vertex v{Matrix3{1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}, Vector3{10.0f, 11.0f, 12.0f},
         Vector2{13.0f, 14.0f}};
ExplicitVertex ev{{1.0f, 4.0f, 7.0f, 2.0f, 5.0f, 8.0f, 3.0f, 6.0f, 9.0f}, {10.0f, 11.0f, 12.0f},
             {13.0f, 14.0f}};
// Has to be done with more nuance apparently
// TEST_ASSERT_EQUAL(float, v, "actual", ev, "wanted", "Vertex not aligned correctly!")
